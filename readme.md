...
2. Более подробный вывод о доходах по каждому активу
    ...
    В настоящее время приложение выводит только ежемесячную прибыль, налог, выкуп/продажу паев ежемесячный капитал. Для получения полной картины доходности стоит:
